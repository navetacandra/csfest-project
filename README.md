...
**Ku-LMSin** menawarkan sistem presensi, schedule, e-learning, dan pengumuman yang terintegasi. **Ku-LMSin** juga memiliki visi _"Semua Layanan dalam Satu Platform"_. Selain menyuguhkan sistem yang terintegasi, **Ku-LMSin** juga menyediakan fitur _notification_ yang akan dikirim ke email mahasiswa dan/atau dosen dengan harapan mahasiswa ataupun dosen tidak tertinggal informasi.
